...
[e_3, CL_3,CDi_3]=PLLT(b3,a0_t3,a0_r3,c_t3,c_r3,aero_t3,aero_r3,geo_t3,geo_r3,N_ref3);
...
for i=1:length(N_vals3)
    ...
    [e3,CL4,CDi3]= PLLT(b3,a0_t3,a0_r3,c_t3,c_r3,aero_t3,aero_r3,geo_t3,geo_r3,N3);
    CL_val3(i)=CL4;
    CDi_val3(i)= CDi3;
end
